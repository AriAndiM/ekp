        ...
        <div class="card card-small mb-4 pt-3">
          <div class="card-header border-bottom text-center">
            <div class="mb-3 mx-auto">
              <img class="rounded-circle" src="../assets/img/dosen.png" alt="User Avatar" width="110">
            </div>
            <h4 class="mb-0"><?= $row['nama_dosen'] ?></h4>
                  ...
                  <form>
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="feFirstName" value="<?= $row['nama_dosen'] ?>" disabled>
                      </div>
                    </div>
                    <div class="form-row">
                      <div class="form-group col-md-12">
                        <label for="feNip">NIP</label>
                        <input type="text" class="form-control" id="feEmailAddress" value="<?= $row['NIP'] ?>" disabled>
                      </div>
                      <div class="form-group col-md-12">
                        <label for="feEmail">Email</label>
                        <input type="text" class="form-control" id="fePassword" value="<?= $row['email_dosen'] ?>" disabled>
                      </div>

                      <div class="form-group col-md-12">
                        <label for="feStatus">Status</label>
                        <input type="text" class="form-control" id="fePassword" value="<?= $row['status_dosen'] ?>" disabled>
                      </div>
                    </div>
                  </form>
                </div>

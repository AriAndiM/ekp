            ...
            <div class="card">
                <div class="card-body">
                  <table class="table table-striped" style="text-align: center;">
                      ...
                      $NIP = $_SESSION['NIP'];
                      $sql = "SELECT * FROM proposal INNER JOIN mahasiswa USING (NIM)  INNER JOIN dosen_pembimbing USING (NIM) WHERE dosen_pembimbing.NIP = '$NIP'";
                      ...
                      <tbody>
                          ...
                          <td><a href="lihat-lpj.php?NIM=<?= $row['NIM']?>"" class="form-control btn btn-outline-info rounded submit px-3">View LPJ</a></td>
                      <?php } ?>
                  </table>

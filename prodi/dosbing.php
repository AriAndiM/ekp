...
<head>
    ...
    <title>Dosen Pembimbing | Prodi</title>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    <div class="page-header row no-gutters py-4">
                        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                            ...
                            <h3 class="page-title">Daftar Dosen Pembimbing</h3>
                        </div>
                    </div>
                    <!-- End Page Header -->
                    <div class="main-content-container container-fluid px-4">
                            ...
                            <div class="container py-5 h-100">
                                <div class="row justify-content-center align-items-center h-100">
                                    <div class="col-12 col-lg-9 col-xl-12">
                                        <div class="card shadow-2-strong card-registration" style="border-radius: 10px; padding: 30px;">
                                            <h4 style="text-align: center;" class=" page-title">Daftar Dosen Kerja Praktek <?php echo date('Y'); ?></h4>
                                            <table class="table table-striped mt-3" style="font-weight: normal;">
                                                ...
                                                <?php
                                                // $query2 = "SELECT * FROM  dosen WHERE status_dosen='aktif' AND kuota > 0 AND kuota < 4;";
                                                $query2 = "SELECT mahasiswa.nama_mahasiswa,dosen.nama_dosen,dosen.NIP FROM mahasiswa JOIN dosen_pembimbing ON mahasiswa.NIM=dosen_pembimbing.NIM JOIN dosen ON dosen_pembimbing.NIP=dosen.NIP WHERE status_dosen='aktif' AND kuota > 0 AND kuota < 4;";

                  ...
                  <div class="col-12 col-lg-9 col-xl-10">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                      <div class="card-body p-4 p-md-5">
                        <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 text-center">Pendaftaran & Pengajuan Surat Pengantar <br> Kerja Praktek</h3>
                        <form method="POST" action="action-pendaftaran.php">
                          ...
                          <div class="mb-4">
                            ...
                            <select class="form-control form-control-lg" name="semester" id="semester" required>
                              ...
                              <option value="Gasal <?php echo $thnSkrg . '/' . $thn3; ?>">Gasal <?php echo $thnSkrg . '/' . $thn3; ?></option>
                            </select>
                          ...
                          <div class="mb-4">
                            ...
                            <div>
                              <input type="date" class="form-control form-control-lg" name="tanggal_pendaftaran" id="tanggal_pendaftaran" required>
                            </div>
                          </div>
                          <div class="mb-4">
                            <span for="">Tanggal batas pendaftaran</span><br>
                            <div>
                              <input type="date" class="form-control form-control-lg" name="tanggal_batas_pendaftaran" id="tanggal_batas_pendaftaran" required>
                            </div>
                          </div>
                          ...
                          <div class="mb-4">
                            ...
                            <div>
                              <input type="date" class="form-control form-control-lg" name="tanggal_batas_surat" id="tanggal_batas_surat" required>
                            </div>
                          </div>
                        ...
                        <table class="table" style="font-weight: normal;">
                          <tr>
                            ...
                            <th>Tgl batas Pengajuan Surat</th>
                            <th>Action</th>
                          </tr>
                          <?php
                          // function tgl indo
                          ...
                          $query3 = "SELECT * FROM prodi ORDER BY id_prodi DESC LIMIT 1";
                          ...
                          ?>
                            <tr>
                              <td><?php echo $i++; ?></td>
                              <td><?php echo tgl_indo($data3['semester']); ?></td>
                              <td><?php echo tgl_indo($data3['tanggal_pendaftaran']); ?></td>
                              <td><?php echo tgl_indo($data3['tanggal_batas_pendaftaran']); ?></td>
                              <td><?php echo tgl_indo($data3['tanggal_batas_surat']); ?></td>
                              <td><a href="edit_pendaftaran.php?id=<?= $data3['id_prodi'] ?>"><button class="btn btn-outline-primary">edit</button></a></td>
                            </tr>
                          <?php } ?>
                        </table>

...
<head>
    ...
    <title>Berita Acara | Prodi</title>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    <div class="page-header row no-gutters py-4">
                        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                            ...
                            <h3 class="page-title">Daftar Berita Acara Mahasiswa</h3>
                        </div>
                    </div>
                    <!-- End Page Header -->
                    <div class="main-content-container container-fluid px-4">
                                ...
                                <div class="row justify-content-center align-items-center h-100">
                                    <div class="col-12 col-lg-9 col-xl-12">
                                        <div class="card shadow-2-strong card-registration" style="border-radius: 10px; padding: 30px;">
                                            <h4 style="text-align: center;" class=" page-title">Daftar Berita Acara Mahasiswa <?php echo date('Y'); ?></h4>
                                            <table class="table table-striped mt-3" style="font-weight: normal;">
                                                ...
                                                <?php
                                                $query2 = "SELECT * FROM berita_acara;";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $data2['berita_acara'] ?></td>
                                                        <td>
                                                            <a href="view-berita-acara.php?id=<?php echo $data2['id_berita_acara']; ?>"><button class="mb-2 btn btn-outline-primary mr-2">view</button></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </table>

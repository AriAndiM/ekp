...
<head>
  ...
  <title>Cetak Mahasiswa Selesai Kerja Praktek</title>
</head>
...
<body>
  ...
  <h3 style="text-align: center;">Daftar Mahasiswa Selesai Kerja Praktek <?php echo date('Y'); ?></h3>
  <div style="margin-top: 5 0px;">
    <table border="1" align="center" style="font-weight: normal; border-collapse: collapse;">
      ...
      $query2 = "SELECT * FROM pendaftaran JOIN mahasiswa ON pendaftaran.NIM=mahasiswa.NIM WHERE status_KP='Selesai Kerja Praktek';";

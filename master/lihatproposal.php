          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              ...
              <ul class="collapse list-unstyled" id="mahasiswa">
                ...
                <li>
                  <a href="lihatproposal.php" class="nav-link active">Proposal Kerja Praktek</a>
                </li>
                <li>
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Proposal Kerja Praktek</h3>
            </div>
          </div>
          <!-- End Page Header -->
          <div class="container">
            <div class="card">
              <div class="card-body">
                ...
                $NIM = $_GET['NIM'];
                $sqll = "SELECT * FROM proposal JOIN mahasiswa USING(NIM) WHERE NIM='$NIM'";

    ...
    <div class="main-content-container container-fluid px-4">
      <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
          ...
          <h3 class="page-title">Detail Instansi</h3>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card card-small mb-4 pt-3">
            <!-- <div class="card-header border-bottom text-center">
              ...
              <?php
              $id = $_GET['id_instansi'];
              $query = "SELECT * FROM instansi WHERE id_instansi = '$id'";
                    ...
                    <form>
                      <div class="form-row">
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" class="form-control" name="nama_instansi" value="<?= $row['nama_instansi'] ?>" readonly>
                        </div>
                        <div class="form-group col-md-6">
                          <label for="Email">Email</label>
                          <input type="text" class="form-control" name="Email" value="<?= $row['email_instansi'] ?>" readonly>
                        </div>
                      </div>
                      <div class="form-row">
                        <label for="Alamat">Alamat</label>
                        <input type="text" class="form-control" name="Alamat" value="<?= $row['alamat_instansi'] ?>" readonly>
                      </div>
                    </form>
                  </div>
                </div>

        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="container">
            <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
              ...
              $query2 = "SELECT * FROM dosen_pembimbing INNER JOIN dosen USING(NIP) WHERE id_dosen_pembimbing = $id_dosen_pembimbing";
              $sql2 = mysqli_query($conn, $query2);
              $data2 = mysqli_fetch_array($sql2)
              ?>
              <h5>Nama Dosen Pembimbing : <?php echo $data2['nama_dosen'] ?></h5>
              <h5>NIP : <?php echo $data2['NIP'] ?></h5>
              <table class="table table-striped" style="font-weight: normal;">
                ...
                <tbody>
                  ...
                  $id_dosen_pembimbing = $_GET['id_dosen_pembimbing'];
                  $query2 = "SELECT * FROM mahasiswa INNER JOIN dosen_pembimbing USING (NIM) WHERE id_dosen_pembimbing = $id_dosen_pembimbing";
                  $sql2 = mysqli_query($conn, $query2);
                  $i = 1;
                  ...
                  ?>
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <a href="ulasandosen.php?NIM=<?php echo $data2['NIM'] ?>" class="form-control btn btn-outline-primary rounded submit px-3">Lihat</a>
                      </td>
                      <td style="text-align: center;">
                        <a href="penilaiandosen.php?NIM=<?php echo $data2['NIM'] ?>" class="form-control btn btn-outline-success rounded submit px-3">Lihat</a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>

        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Data Mahasiswa Bimbingan</h3>
            </div>
          </div>
          <!-- End Page Header -->
          <div class="container">
            <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
              <?php
              $id_daftar_pembimbing = $_GET['id_daftar_pembimbing'];
              $query2 = "SELECT * FROM daftar_pembimbing JOIN instansi USING(id_instansi) WHERE id_daftar_pembimbing = $id_daftar_pembimbing";
              $sql2 = mysqli_query($conn, $query2);
              $data2 = mysqli_fetch_array($sql2)
              ?>
              <h5>Nama Pembimbing Lapangan : <?php echo $data2['nama_pembimbing_lapangan'] ?></h5>
              <h5>Asal Instansi : <?php echo $data2['nama_instansi'] ?></h5>
              <table class="table table-striped" style="font-weight: normal;">
                ...
                <tbody>
                  ...
                  $id_daftar_pembimbing = $_GET['id_daftar_pembimbing'];
                  $query2 = "SELECT * FROM mahasiswa JOIN pembimbing_lapangan USING(NIM) JOIN daftar_pembimbing USING(id_daftar_pembimbing) WHERE id_daftar_pembimbing = $id_daftar_pembimbing";
                  $sql2 = mysqli_query($conn, $query2);
                  $i = 1;
                  ...
                  ?>
                    <tr>
                      ...
                      <td style="text-align: center;">
                        <a href="lihatulasan.php?NIM=<?php echo $data2['NIM'] ?>" class="form-control btn btn-outline-primary rounded submit px-3">Lihat</a>
                      </td>
                      <td style="text-align: center;">
                        <a href="lihatnilai.php?NIM=<?php echo $data2['NIM'] ?>" class="form-control btn btn-outline-success rounded submit px-3">Lihat</a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>

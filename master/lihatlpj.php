          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              ...
              <ul class="collapse list-unstyled" id="mahasiswa">
                ...
                <li>
                  <a href="lihatproposal.php" class="nav-link">Proposal Kerja Praktek</a>
                </li>
                <li>
                  <a href="lpj.php" class="nav-link active">laporan Kerja Praktek</a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <ul class="collapse list-unstyled" id="tu">
                <li>
                  <a href="daftarMahasiswaTU.php" class="nav-link ">Informasi Pendaftaran</a>
                </li>
                <li>
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Laporan Pertanggung Jawaban</h3>
            </div>
          </div>
          <!-- End Page Header -->
          <div class="container">
            <div class="card">
              <div class="card-body">
                ...
                $NIM = $_GET['NIM'];
                $sqll = "SELECT * FROM laporan JOIN mahasiswa USING(NIM) WHERE NIM='$NIM'";
                $query = mysqli_query($conn, $sqll);
                $row = mysqli_num_rows($query);
                if ($row == 0) { ?>
                  <h5 style="color: red;">Laporan pertanggung jawaban belum di upload</h5>
                <?php } else {

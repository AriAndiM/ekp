          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              ...
              <ul class="collapse list-unstyled" id="mahasiswa">
                ...
                <li>
                  <a href="proposal.php" class="nav-link active">Proposal Kerja Praktek</a>
                </li>
                <li>
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Data Proposal Mahasiswa Kerja Praktek</h3>
            </div>
          </div>
          <!-- End Page Header -->
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
            ...
            <tr>
              ...
              <tbody>
                ...
                $query2 = "SELECT * FROM proposal JOIN mahasiswa USING(NIM) JOIN pendaftaran USING(NIM) JOIN form_pengantar USING(id_pendaftaran)";
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><a href="lihatproposal.php?NIM=<?php echo $data2['NIM'] ?>" class="form-control btn btn-outline-info rounded submit px-3">Lihat</a></td>
                </tr>
              </tbody>
            </table>
          </div>

        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Data Mahasiswa Kerja Praktek</h3>
            </div>
          </div>
          <!-- End Page Header -->
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
            <table class="table table-striped" style="font-weight: normal;">
              ...
              <tbody>
                ...
                $query2 = "SELECT * FROM mahasiswa JOIN pembimbing_lapangan USING(NIM) JOIN daftar_pembimbing USING(id_daftar_pembimbing) JOIN instansi USING(id_instansi) WHERE id_instansi = $id_instansi";

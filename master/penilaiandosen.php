            ...
            <div class="card">
              <div class="card-body">
                ...
                if ($row == 0) { ?>
                  ...
                  $query4 = "SELECT * FROM mahasiswa JOIN dosen_pembimbing USING (NIM) WHERE id_dosen_pembimbing='$id';";
                ...
                <?php } else { ?>
                  <table class="table table-striped" style="text-align: center;">
                    ...
                    <tbody>
                      ...
                      $query4 = "SELECT * FROM penilaian_dosen WHERE NIM = $NIM";
                      $sql4 = mysqli_query($conn, $query4);
                      $i = 1;
                      $row4 = mysqli_fetch_array($sql4) ?>
                      <tr>
                        <td><?php echo $i++; ?></td>
                        <td>Perumusan Masalah</td>
                        <td><?php echo $row4['rumusan_masalah']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $i++; ?></td>
                        <td>Manfaat Hasil Kerja Praktek</td>
                        <td><?php echo $row4['manfaat']; ?></td>
                      </tr>
                      <tr>
                        <td><?php echo $i++; ?></td>
                        <td>Tinjauan Pustaka</td>
                        <td><?php echo $row4['tinjauan_pustaka']; ?></td>
                      </tr>
                    </tbody>
                      <tr>
                        <td><?php echo $i++; ?></td>
                        <td>Metode Penelitian</td>
                        <td><?php echo $row4['metode_penelitian']; ?></td>
                      </tr>
                    </tbody>
                      <tr>
                        <td><?php echo $i++; ?></td>
                        <td>Presentasi dan Tanya Jawab</td>
                        <td><?php echo $row4['presentasi']; ?></td>
                      </tr>
                    </tbody>
                  </table>
                <?php } ?>

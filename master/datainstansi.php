      ...
      <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
        ...
        <div class="nav-wrapper">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="datainstansi.php">
                <i class="material-icons">home</i>
                <span>Instansi</span>
              </a>
            </li>
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Data Instansi</h3>
            </div>
          </div>
          <!-- End Page Header -->
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $data2['nama_instansi'] ?></td>
                    <td><a href="detailinstnasi.php?id_instansi=<?php echo $data2['id_instansi'] ?>" class="form-control btn btn-outline-warning rounded submit px-3">Lihat</a></td>
                    <td>
                      <a href="lihatmhs.php?id_instansi=<?php echo $data2['id_instansi'] ?>" class="btn btn-outline-primary rounded submit px-3">Mahasiswa</a>
                      <a href="lihatpl.php?id_instansi=<?php echo $data2['id_instansi'] ?>" class="btn btn-outline-success rounded submit px-3">Pembimbing</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>

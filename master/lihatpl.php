          ...
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
            <table class="table table-striped">
              <thead class="table-dark">
                ...
                <th style="text-align: center;">Nama Pembimbing Lapangan</th>
                <th style="text-align: center;">Email Pembimbing Lapangan</th>
              </thead>
              <tbody>
                <?php
                ...
                $query2 = "SELECT * FROM daftar_pembimbing JOIN instansi USING(id_instansi) WHERE id_instansi = $id_instansi";

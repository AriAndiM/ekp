    ...
    <div class="main-content-container container-fluid px-4">
      <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
          ...
          <h3 class="page-title">Data Dosen dan Mahasiswa Yang di Ampu</h3>
        </div>
      </div>
      <div class="container">
            <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
              <table class="table table-striped" style="font-weight: normal;">
                ...
                $query2 = "SELECT * FROM dosen_pembimbing INNER JOIN dosen USING (NIP)";
                ...
                ?>
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <a href="dosenmahasiswa.php?id_dosen_pembimbing=<?php echo $data2['id_dosen_pembimbing'] ?>" class="form-control btn btn-outline-info rounded submit px-3">Lihat</a>
                    </td>
                  </tr>
                <?php } ?>
              </table>

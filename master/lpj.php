        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Data Laporan Kerja Praktek</h3>
            </div>
          </div>
          <!-- End Page Header -->
          <div class="container">
            <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
              <table class="table table-striped" style="font-weight: normal;">
                ...
                <tbody>
                  ...
                  $query2 = "SELECT * FROM mahasiswa JOIN laporan ON laporan.NIM=mahasiswa.NIM;";
                  ...
                  ?>
                    <tr>
                      ...
                      <td style="text-align: center;"><a href="lihatlpj.php?NIM=<?php echo $data2['NIM'] ?>" class="form-control btn btn-outline-info rounded submit px-3">Lihat</a></td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>

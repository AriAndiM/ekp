          ...
          <div class="container">
            <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
              <table class="table table-striped" style="font-weight: normal;">
                ...
                $query2 = "SELECT * FROM daftar_pembimbing JOIN instansi USING(id_instansi)";
                // JOIN pembimbing_lapangan USING(id_daftar_pembimbing)";
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo $data2['NIP_pembimbing_lapangan'] ?></td>
                    <td><?php echo $data2['nama_pembimbing_lapangan'] ?></td>
                    <td><?php echo $data2['nama_instansi'] ?></td>
                    <td><?php echo $data2['email_pembimbing_lapangan'] ?></td>
                    <td style="text-align: center;">
                      <a href="mhsbimbingan.php?id_daftar_pembimbing=<?php echo $data2['id_daftar_pembimbing'] ?>" class="form-control btn btn-outline-info rounded submit px-3">Lihat</a>
                    </td>
                  </tr>
                <?php } ?>
              </table>

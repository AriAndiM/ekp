			...
			<div class="container">
				<div class="row g-0 d-flex align-items-center">
					<div class="col-lg-4 d-none d-lg-flex">
						<img src="assets/img/log_mhs.svg" alt="Trendy Pants and Shoes" class="w-100 rounded-t-5 rounded-tr-lg-0 rounded-bl-lg-5" />
					</div>
					<div class="col-lg-8">
						<div class="card-body py-5 px-md-5">
							<h3 style="color: #37517e" class="mt-3 mb-4">Login Mahasiswa</h3>
							<form method="POST" action="cek-login-mhs.php">
								<!-- Email input -->
								...
								<!-- Password input -->
								<div class="form-outline mb-4">
									<input type="password" id="password_mhs" name="password_mhs" class="form-control" required />
									<label class="form-label" for="password_mhs">Password</label>
								</div>
								...
								<div class="form-outline mb-4">
									<a href="regis_mahasiswa.php" class="form-label" for="form2Example2">Belum memiliki akun? Registrasi sekarang!</a>
								</div>
							</form>
						</div>
					</div>

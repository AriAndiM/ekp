                          ...
                          <form method="POST" action="action-update-profil.php">
                            ...
                            <div class="form-row">
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="jenis_kelamin" placeholder="jenis_kelamin" value="<?php echo $row['jenis_kelamin'] ?>">
                              </div>
                            </div>
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                <label for="tanggal_lahir">Tanggal Lahir</label>
                                <input type="text" class="form-control" name="tanggal_lahir" value="<?= date('d-m-Y', strtotime($row['tanggal_lahir'])) ?>">
                              </div>
                              <div class="form-group col-md-6">

    ...
    <div style="padding: 50px;">
        <table border="1" align="center" style="border-collapse: collapse; padding-left: 0%;padding-right: 0%;max-width:max-content;">
            <tr>
                ...
                <td style="text-align: center; padding-left: 20px; padding-right: 20px; width: 485px;">TEKNIK INFORMATIKA <br><br> <b>BERITA ACARA UJIAN <br> KERJA PRAKTEK</b></td>
                <td style="width: 25px; text-align: center;  padding: 10px;">BERKAS <br> <b> KP-3 </b></td>
            </tr>
        </table>
        <br>
        <table align="center" style="border-collapse: collapse; padding-left: 0%;padding-right: 0%;max-width:max-content;">
            <tr>
                <td style="padding-left: 15px; width: 745px;" colspan="4">
                    Telah dilaksanakan Ujian Kerja Praktek Tahun Ajaran ......../.......
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table align="center" border="1" style="border-collapse: collapse; padding-left: 0%;padding-right: 0%;max-width:max-content; text-align:center;">
            ...
            <tr>
                <td style="width: 364px;">
                    Pembimbing KP <br><br><br><br><br> <b><u></u></b> <br> NIP. <br>
                    <p></p>
                </td>
                <td style="width: 363px;">
                    Penguji KP <br><br><br><br><br> <b><u></u></b> <br> NIP. <br>
                    <p></p>
                </td>
            </tr>
        </table>
        ...
        <table align="center" style="border-collapse: collapse; padding-left: 0%;padding-right: 0%;max-width:max-content; text-align:center;">
            <tr>
                <td colspan="2" style="width: 730px;">
                    Mengetahui, <br> Koordinator Kerja Praktek <br><br><br><br><br> <b><u></u></b> <br> NIP.
                </td>
            </tr>
        </table>
    </div>

      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="row-lg-4">
            ...
            $nim = $_SESSION['NIM'];
            // $query2 = "SELECT * FROM dosen JOIN dosen_pembimbing ON dosen.NIP=dosen_pembimbing.NIP JOIN monitoring_dosen ON dosen_pembimbing.id_dosen_pembimbing=monitoring_dosen.id_dosen_pembimbing WHERE dosen_pembimbing.NIM='$nim'";
            $query2 = "SELECT * FROM dosen JOIN dosen_pembimbing ON dosen.NIP=dosen_pembimbing.NIP JOIN monitoring_dosen ON dosen_pembimbing.NIM=monitoring_dosen.NIM WHERE monitoring_dosen.NIM='$nim' AND dosen_pembimbing.NIM='$nim';";
            ...
            ?>
              <div class="card card-small card-post mb-4">
                <div class="card-body">
                  ...
                  <p class="card-text text-muted"><?php echo $row['catatan_monitoring_dosen']; ?></p>
                </div>
                <div class="card-footer border-top d-flex">
                  <div class="card-post__author d-flex">
                    ...
                    <div class="d-flex flex-column justify-content-center ml-3">
                      <?php
                      $query3 = "SELECT * FROM dosen WHERE NIP = '$NIP'";
                      $sql3 = mysqli_query($conn, $query3);
                      while ($row3 = mysqli_fetch_array($sql3)) {
                      ?>
                        <span class="card-post__author-name"><?php echo $row3['nama_dosen']; ?></span>
                      <?php } ?>
                      <small class="text-muted"><?php echo tgl_indo($row['tanggal_monitoring_dosen']); ?></small>
                    </div>
                  </div>

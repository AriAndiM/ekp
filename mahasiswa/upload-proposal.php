      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="container">
          <div class="card" style="padding: -10px; height: fit-content; margin: 10%;">
            <h3 style="text-align: center; margin-top: 20px; margin-left: 20px; margin-bottom: 0px;">Upload Proposal</h3>
            <div style="outline: 3px dashed black; padding: 30px; border-radius: 15px; margin: 30px;">
              <form method="POST" action="insert-upload-proposal.php" enctype="multipart/form-data">
                ...
                <div style="text-align: center;">
                  ...
                  <button class="btn btn-primary" style="margin: 10px;" type="submit" name="submit" value="<?php echo $val; ?>" class="btn">submit</button>
                </div>
              </form>
            </div>
            <br>

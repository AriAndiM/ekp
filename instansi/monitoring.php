...
<head>
    ...
    <title>Monitoring | Pembimbing Lapangan</title>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
                            ...
                            <tbody>
                                ...
                                while ($row4 = mysqli_fetch_array($sql4)) { ?>
                                    <tr>
                                        ...
                                        <td><a href="ulasan.php?NIM=<?php echo $row4['NIM'] ?>" class="form-control btn btn-outline-secondary rounded submit px-3">Berikan Ulasan</a></td>
                                        <td><a href="hasilUlasan.php?NIM=<?php echo $row4['NIM'] ?>" class="form-control btn btn-outline-info rounded submit px-3">Lihat Ulasan</a></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>

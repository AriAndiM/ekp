...
<head>
  ...
  <title>Laporan Kerja Praktek | Pembimbing Lapangan</title>
  <meta charset="utf-8">
  <meta http-equiv="x-ua-compatible" content="ie=edge">
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Laporan Kerja Praktek</h3>
            </div>
          </div>
          <!-- End Page Header -->
          <div class="container">
            <div class="card">
              <div class="card-body">
                ...
                if ($row == 0) { ?>
                  <h5 style="color: red;">Laporan Kerja Praktek belum di upload</h5>
                <?php } else {

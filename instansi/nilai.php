            ...
            <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3>PENILAIAN</h3>
                            <form action="insert-nilai.php" method="POST">
                                <?php
                                $NIM = $_GET['NIM'];
                                ...
                                <?php } ?>
                                <?php
                                $id_daftar_pembimbing1 = $_SESSION['id_daftar_pembimbing'];
                                // echo $id_daftar_pembimbing1;
                                $query = "SELECT * FROM monitoring_instansi WHERE id_daftar_pembimbing = '$id_daftar_pembimbing1'";
                                $sql = mysqli_query($conn, $query);
                                ...
                                <div>
                                    <di class="mb-3">
                                        ...
                                        while ($row = mysqli_fetch_array($sql)) { ?>
                                            ...
                                            <input type="text" disabled class="form-control mb-3" id="exampleFormControlInput1" value="<?php echo $row['nama_mahasiswa'] ?>" name="nama_mahasiswa">

                                            <label for="exampleFormControlInput1" class="form-label">NIM</label>
                                            <input type="text" disabled class="form-control mb-3" id="exampleFormControlInput1" value="<?php echo $row['NIM'] ?>" name="NIM">

                                        <?php } ?>
                                        <label for="exampleFormControlInput1" class="form-label">Tanggal Penilaian</label>
                                        <input type="date" class="form-control mb-3" id="exampleFormControlInput1" placeholder="0-100" name="tanggal_penilaian_instansi" required>

                                        <label for="exampleFormControlInput1" class="form-label">Kemampuan Menyelesaikan Tugas</label>
                                        <input type="number" class="form-control mb-3" id="exampleFormControlInput1" placeholder="0-100" name="kemampuan" required>

                                        <label for="exampleFormControlInput1" class="form-label">Attitude</label>
                                        <input type="number" class="form-control mb-3" id="exampleFormControlInput1" placeholder="0-100" name="sikap" required>

                                        <label for="exampleFormControlInput1" class="form-label">Kedisiplinan</label>
                                        <input type="number" class="form-control mb-3" id="exampleFormControlInput1" placeholder="0-100" name="kedisiplinan" required>

                                        <button type="submit" class="btn btn-outline-primary">Submit</button>
                                        <button type="reset" class="btn btn-outline-danger">Reset</button>
                                        <a href="penilaian.php" class="btn btn-outline-warning">Back</a>
                                </div>
                            </form>
                        </div>
                    </div>

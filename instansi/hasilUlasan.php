...
<head>
  ...
  <title>Hasil Ulasan | Pembimbing Lapangan</title>
        ...
        <div class="main-content-container container-fluid px-4">
          ...
          <div class="page-header row no-gutters py-4">
            <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
              ...
              <h3 class="page-title">Hasil Monitoring Pembimbing Lapangan</h3>
            </div>
          </div>
          <div class="container">
            <div class="card">
              <div class="card-body">
                ...
                <table class="table table-striped" style="text-align: center;">
                  ...
                  <tbody>
                    <?php
                    $NIM = $_GET['NIM'];
                    $query4 = "SELECT * FROM `monitoring_instansi` WHERE NIM = $NIM ORDER BY monitoring_instansi.tanggal_monitoring_instansi DESC;";
                    $sql4 = mysqli_query($conn, $query4);
                    $i = 1;
                    while ($row4 = mysqli_fetch_array($sql4)) { ?>
                      <tr>
                        <td><?php echo $row4['tanggal_monitoring_instansi'] ?></td>
                        <td><?php echo $row4['judul_ulasan']; ?></td>
                        <td><?php echo $row4['catatan_monitoring_instansi']; ?></td>
                      </tr>
                    <?php } ?>
                  </tbody>
                </table>

                ...
                <div class="main-content-container container-fluid px-4">
                    ...
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px; padding: 30px;">
                        <table class="table table-striped" style="text-align: center;">
                            ...
                            <tbody>
                                <?php
                                $query4 = "SELECT * FROM mahasiswa JOIN pembimbing_lapangan ON mahasiswa.NIM=pembimbing_lapangan.NIM WHERE id_daftar_pembimbing='$id'AND mahasiswa.status_KP='Mengunggah Laporan';";
